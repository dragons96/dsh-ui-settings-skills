/**
 * Build both halves of the ui-settings-skills plugin:
...
// which stays 'ui-settings-skills' (exported `name` in src/index.ts).
const PKG_ID = '@dsh-mixxed/dsh-client-ui-settings-skills'
